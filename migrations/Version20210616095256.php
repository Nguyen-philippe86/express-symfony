 ...
 */
final class Version20210616095256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reviews_product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, product_id INTEGER DEFAULT NULL, note INTEGER NOT NULL, comment CLOB DEFAULT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__address AS SELECT id, user_id, full_name, company, address, complement, phone, city, postal, country FROM address');
        $this->addSql('DROP TABLE address');
        $this->addSql('CREATE TABLE address (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, full_name VARCHAR(255) NOT NULL COLLATE BINARY, company VARCHAR(255) DEFAULT NULL COLLATE BINARY, address VARCHAR(255) NOT NULL COLLATE BINARY, complement VARCHAR(255) DEFAULT NULL COLLATE BINARY, phone INTEGER NOT NULL, city VARCHAR(255) NOT NULL COLLATE BINARY, postal INTEGER NOT NULL, country VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_D4E6F81A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO address (id, user_id, full_name, company, address, complement, phone, city, postal, country) SELECT id, user_id, full_name, company, address, complement, phone, city, postal, country FROM __temp__address');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__address AS SELECT id, user_id, full_name, company, address, complement, phone, city, postal, country FROM address');
        $this->addSql('DROP TABLE address');
        $this->addSql('CREATE TABLE address (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, full_name VARCHAR(255) NOT NULL, company VARCHAR(255) DEFAULT NULL, address VARCHAR(255) NOT NULL, complement VARCHAR(255) DEFAULT NULL, phone INTEGER NOT NULL, city VARCHAR(255) NOT NULL, postal INTEGER NOT NULL, country VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO address (id, user_id, full_name, company, address, complement, phone, city, postal, country) SELECT id, user_id, full_name, company, address, complement, phone, city, postal, country FROM __temp__address');
        $this->addSql('DROP TABLE __temp__address');
        $this->addSql('CREATE INDEX IDX_D4E6F81A76ED395 ON address (user_id)');
        $this->addSql('DROP INDEX IDX_7CE748AA76ED395');
